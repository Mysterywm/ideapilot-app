...
test('updateUser() updates a user', async () => {
    ...
    (0, nock_1.default)('https://api.clerk.dev')
        .patch('/v1/users/user_1oBNj55jOjSK9rOYrT5QHqj7eaK', (0, snakecase_keys_1.default)(params))
        .replyWithFile(200, __dirname + '/responses/updateUser.json', {
        'Content-Type': '',
    });
    const user = await TestBackendAPI_1.TestBackendAPIClient.users.updateUser('user_1oBNj55jOjSK9rOYrT5QHqj7eaK', params);
    expect(user.firstName).toEqual('Boss');
