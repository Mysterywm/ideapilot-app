...
test('deserializes an Organization object', () => {
    const organization = (0, Deserializer_1.default)(organizationJSON);
    expect(organization).toBeInstanceOf(resources_1.Organization);
});
test('deserializes an array of Organization objects', () => {
    const organizations = (0, Deserializer_1.default)([organizationJSON]);
    expect(organizations).toBeInstanceOf(Array);
    expect(organizations.length).toBe(1);
    expect(organizations[0]).toBeInstanceOf(resources_1.Organization);
});
