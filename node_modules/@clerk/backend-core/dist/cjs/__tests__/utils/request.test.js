...
describe('check cross-origin-referrer request utility', () => {
    test('is not CO with IPv6', () => {
        ...
        expect((0, request_1.checkCrossOrigin)({ originURL, host })).toEqual(false);
    });
    ...
    test('is CO with mixed default security ports', () => {
        ...
        expect((0, request_1.checkCrossOrigin)({ originURL, host })).toEqual(true);
    });
    ...
    test('is CO when HTTPS to HTTP with present x-forwarded-proto', () => {
        ...
        expect((0, request_1.checkCrossOrigin)({
            originURL,
            host,
            forwardedHost,
            forwardedProto,
    ...
    test('is CO when HTTPS to HTTP with forwarded port', () => {
        ...
        expect((0, request_1.checkCrossOrigin)({ originURL, host, forwardedPort })).toEqual(true);
    });
