...
export declare class Base {
    ...
    getAuthState: ({ cookieToken, clientUat, headerToken, origin, host, forwardedHost, forwardedPort, forwardedProto, referrer, userAgent, authorizedParties, fetchInterstitial, }: AuthStateParams) => Promise<AuthState>;
}
export {};
