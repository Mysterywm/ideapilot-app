...
class Clerk extends backend_core_1.ClerkBackendAPI {
    constructor({ apiKey = defaultApiKey, serverApiUrl = defaultServerApiUrl, apiVersion = defaultApiVersion, httpOptions = {}, jwksCacheMaxAge = JWKS_MAX_AGE, } = {}) {
        ...
        this.base = new backend_core_1.Base(importKey, verifySignature, crypto_1.decodeBase64, process.env.CLERK_JWT_KEY ? undefined : loadCryptoKey);
    }
    ...
    expressWithSession({ onError, authorizedParties } = {
    ...
    expressRequireSession({ onError, authorizedParties } = {
    ...
    withSession(handler, { onError, authorizedParties } = {
        onError: this.defaultOnError,
    }) {
    ...
    requireSession(handler, { onError, authorizedParties } = {
        onError: this.strictOnError,
    }) {
