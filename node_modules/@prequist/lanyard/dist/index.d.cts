...
declare namespace API {
     ...
     */
    type EitherAPIResponse<T> = SuccessfulAPIResponse<T> | ErroredAPIResponse;
    /**
     ...
     */
    function isSuccess<T>(response: Response, body: EitherAPIResponse<T>): body is SuccessfulAPIResponse<T>;
    /**
     ...
     */
    function isErrored<T>(response: Response, body: EitherAPIResponse<T>): body is ErroredAPIResponse;
}
/**
 * The routes that Lanyard and this library support
 */
declare namespace Routes {
    type GetPresence = API.EitherAPIResponse<Types.Presence>;
}
/**
...
declare namespace Types {
     ...
     */
    enum WellKnownNameplatePalettes {
        NONE = "none",
        CRIMSON = "crimson",
        BERRY = "berry",
        SKY = "sky",
     ...
     */
    interface NameplateCollectible {
...
declare class LanyardHTTPError extends Error {
    readonly request: Request;
    readonly response: Response;
    readonly body: API.ErroredAPIResponse;
    constructor(request: Request, response: Response, body: API.ErroredAPIResponse);
}
declare function get(id: Types.Snowflake): Promise<Types.Presence>;

export { API, LanyardHTTPError, Routes, Types, get };
